...
var LocalImage = dojo.declare("dojox.editor.plugins.LocalImage", LinkDialog.ImgLinkDialog, {
	...
	linkDialogTemplate: [
		...
		"<label for='com.orange.clara.cloud.dbaas:cloud-orange-dbaas-admin-gui:war:1.9-SNAPSHOT_urlInput' title='${prePopuTextUrl}${prePopuTextBrowse}'>${url}</label>",
		...
		"id='com.orange.clara.cloud.dbaas:cloud-orange-dbaas-admin-gui:war:1.9-SNAPSHOT_urlInput' name='urlInput' intermediateChanges='true' invalidMessage='${invalidMessage}' " +
		"prePopuText='&lt;${prePopuTextUrl}${prePopuTextBrowse}&gt'>",
		"</td><td>",
		"<div id='com.orange.clara.cloud.dbaas:cloud-orange-dbaas-admin-gui:war:1.9-SNAPSHOT_browse' style='display:${uploadable}'>${browse}</div>",
		"</td></tr><tr><td colspan='2'>",
		"<label for='com.orange.clara.cloud.dbaas:cloud-orange-dbaas-admin-gui:war:1.9-SNAPSHOT_textInput'>${text}</label>",
		"</td></tr><tr><td>",
		"<input dojoType='dijit.form.TextBox' required='false' id='com.orange.clara.cloud.dbaas:cloud-orange-dbaas-admin-gui:war:1.9-SNAPSHOT_textInput' " +
		"name='textInput' intermediateChanges='true' selectOnClick='true' class='dijitEditorEilDialogField'>",
		"</td><td></td></tr><tr><td>",
		"</td><td>",
		"</td></tr><tr><td colspan='2'>",
		"<button dojoType='dijit.form.Button' id='com.orange.clara.cloud.dbaas:cloud-orange-dbaas-admin-gui:war:1.9-SNAPSHOT_setButton'>${set}</button>",
		"</td></tr></table>"
	].join(""),
