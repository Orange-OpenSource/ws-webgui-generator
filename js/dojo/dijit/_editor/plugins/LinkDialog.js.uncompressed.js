define("dijit/_editor/plugins/LinkDialog", [
	...
	var LinkDialog = declare("dijit._editor.plugins.LinkDialog", _Plugin, {
		...
		linkDialogTemplate: [
			...
			"<label for='com.orange.clara.cloud.dbaas:cloud-orange-dbaas-admin-gui:war:1.9-SNAPSHOT_urlInput'>${url}</label>",
			"</td><td>",
			"<input data-dojo-type='dijit.form.ValidationTextBox' required='true' " +
				"id='com.orange.clara.cloud.dbaas:cloud-orange-dbaas-admin-gui:war:1.9-SNAPSHOT_urlInput' name='urlInput' data-dojo-props='intermediateChanges:true'/>",
			"</td></tr><tr><td>",
			"<label for='com.orange.clara.cloud.dbaas:cloud-orange-dbaas-admin-gui:war:1.9-SNAPSHOT_textInput'>${text}</label>",
			"</td><td>",
			"<input data-dojo-type='dijit.form.ValidationTextBox' required='true' id='com.orange.clara.cloud.dbaas:cloud-orange-dbaas-admin-gui:war:1.9-SNAPSHOT_textInput' " +
				"name='textInput' data-dojo-props='intermediateChanges:true'/>",
			"</td></tr><tr><td>",
			"<label for='com.orange.clara.cloud.dbaas:cloud-orange-dbaas-admin-gui:war:1.9-SNAPSHOT_targetSelect'>${target}</label>",
			"</td><td>",
			"<select id='com.orange.clara.cloud.dbaas:cloud-orange-dbaas-admin-gui:war:1.9-SNAPSHOT_targetSelect' name='targetSelect' data-dojo-type='dijit.form.Select'>",
			...
			"<button data-dojo-type='dijit.form.Button' type='submit' id='com.orange.clara.cloud.dbaas:cloud-orange-dbaas-admin-gui:war:1.9-SNAPSHOT_setButton'>${set}</button>",
			"<button data-dojo-type='dijit.form.Button' type='button' id='com.orange.clara.cloud.dbaas:cloud-orange-dbaas-admin-gui:war:1.9-SNAPSHOT_cancelButton'>${buttonCancel}</button>",
			"</td></tr></table>"
		].join(""),
	...
	var ImgLinkDialog = declare("dijit._editor.plugins.ImgLinkDialog", [LinkDialog], {
		...
		linkDialogTemplate: [
			...
			"<input dojoType='dijit.form.ValidationTextBox' regExp='${urlRegExp}' " +
				"required='true' id='com.orange.clara.cloud.dbaas:cloud-orange-dbaas-admin-gui:war:1.9-SNAPSHOT_urlInput' name='urlInput' data-dojo-props='intermediateChanges:true'/>",
			"</td></tr><tr><td>",
			"<label for='com.orange.clara.cloud.dbaas:cloud-orange-dbaas-admin-gui:war:1.9-SNAPSHOT_textInput'>${text}</label>",
			"</td><td>",
			"<input data-dojo-type='dijit.form.ValidationTextBox' required='false' id='com.orange.clara.cloud.dbaas:cloud-orange-dbaas-admin-gui:war:1.9-SNAPSHOT_textInput' " +
				"name='textInput' data-dojo-props='intermediateChanges:true'/>",
			"</td></tr><tr><td>",
			"</td><td>",
			"</td></tr><tr><td colspan='2'>",
